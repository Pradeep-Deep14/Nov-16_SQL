CREATE TABLE zomato_orders(order_id INT PRIMARY KEY, customer_id INT, order_date DATE, price FLOAT, city VARCHAR(25)); 
INSERT INTO zomato_orders 
	(order_id, customer_id, order_date, price, city)
	VALUES
